...
public class ContractRestController {
	...
	@RequestMapping(value="/contractInsert", method=RequestMethod.POST)
	 public PaymentPrePayInvoiceInput createContract(@ModelAttribute ContractInsert contractInsert , Model model,Principal principal) {
		...
		try {
			...
			System.out.println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+contractInsert.getDuration() + " " + contractInsert.getConNumber());
	...
	public void saveBatchContract(@ModelAttribute BatchContract batchContract, Model model, Principal principal) {
		...
		System.out.println(
				"batchContract.batchContract.getInvoiceDeliveryType() = " + batchContract.getInvoiceDeliveryType());
		...
		System.out.println("batchContract.getContractDiscountEffectStartDateTime() = "
				+ batchContract.getContractDiscountEffectStartDateTime());
		System.out.println("batchContract.getContractDiscountEffectEndDateTime() = "
				+ batchContract.getContractDiscountEffectEndDateTime());
