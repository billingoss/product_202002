...
public class CustomerLogic implements CustomerService {
	...
	public int saveCustomer(Customer customer) {
		// TODO Auto-generated method stub
		int customerNumber = customerRepository.saveCustomer(customer);
	...
	@Override
	public List<Customer> findCustomerUnique(Customer customer) {
		// TODO Auto-generated method stub
		List<Customer> list = customerRepository.findCustomerUnique(customer);
		return list;
	}
}
