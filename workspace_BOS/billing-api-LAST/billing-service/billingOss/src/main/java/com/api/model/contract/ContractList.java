...
public class ContractList extends Criteria {
	...
	public String getAdditionType1() {
		return additionType1;
	}

	public void setAdditionType1(String additionType1) {
		this.additionType1 = additionType1;
	}

	public String getAdditionType2() {
		return additionType2;
	}

	public void setAdditionType2(String additionType2) {
		this.additionType2 = additionType2;
	}
	...
	public String getSameCustomerYn() {
		return sameCustomerYn;
	}

	public void setSameCustomerYn(String sameCustomerYn) {
		this.sameCustomerYn = sameCustomerYn;
	}
