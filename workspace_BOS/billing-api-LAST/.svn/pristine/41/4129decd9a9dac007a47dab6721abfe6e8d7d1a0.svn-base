...
public class DateUtil {
	...
	***************************************************************/
	 ...
	 * 현재년월을 리턴한다.
	 * @param :
	 * @return : String buf(Output Value) //yyyyMMdd
	 ***************************************************************/
	...
	* @return String delim format 형식으로 리턴
	***************************************************************/
	public static String getDateTime(String sDatetime) {

		String changeDate ="";
		//yyyyMMdd 이거나 yyyy-MM-dd 가 아니면 0리턴
		if(sDatetime == null || sDatetime.length() <12) {
		return "";
		}
...
/*		Calendar cal = Calendar.getInstance(Locale.getDefault());
	...
	**********************************************************/
	 ...
	 * @return
	**********************************************************/
	public static String getMaximumOfMonth(String yyyyMMdd) {
		String lastDate = "";
		int year = 0;
		int month = 0;
		int day = 0;
		if(yyyyMMdd != null && !"".equals(yyyyMMdd) && yyyyMMdd.length() == 8) {			
			...
			//반환 값 설정
			lastDate = yyyyMMdd.substring(0,6)+Integer.toString(cal.getActualMaximum(Calendar.DAY_OF_MONTH));			
		}
