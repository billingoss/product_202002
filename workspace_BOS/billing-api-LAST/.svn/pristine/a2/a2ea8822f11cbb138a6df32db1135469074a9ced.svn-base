...
public interface OrderService 
{
	...
	List<Order> getChannelItemList(Order order);
	List<Order> getProviderInformationByCode(Order order);
	...
	List<Order> getCustomerNumber(Order order);
	...
	List<Order> getProviderInformation(Order order);
