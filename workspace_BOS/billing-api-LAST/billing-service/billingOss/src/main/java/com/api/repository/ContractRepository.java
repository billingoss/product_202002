...
public interface ContractRepository {
	...
	List<ContractInsert> getProductListByGroup(ContractInsert contractInsert); 
	List<ContractInsert> getDiscountList(ContractInsert contractInsert); 
	List<ContractInsert> getProduct(ContractInsert contractInsert);
	...
	List<ContractInsert> getDeliveryChargeAmount(ContractInsert contractInsert);
	List<ContractInsert> getCustomerByChannelCustomerNumber(ContractInsert contractInsert);
	List<ContractInsert> getDeliveryDateByDeliverySeq(ContractInsert contractInsert);
	int insertDeliveryDetailByDeliveryDay(ContractInsert contractInsert);
	int insertContractAddition(ContractInsert contractInsert);
	int updateCustomerEmail(ContractInsert contractInsert);
	List<ContractInsert> getProviderTerms(ContractInsert contractInsert); 
	List<ContractInsert> getContractByChannelOrderNumber(ContractInsert contractInsert); 
}
