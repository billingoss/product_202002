...
public class Invoice {
	...
	private String contractState;					//결제상태
	...
	private String sendTargetYn ; 				//전송대상여부
	private int deliveryTotalCount;				//총 배송 대상 건수
	private int deliveryDoneCount;				//배송 완료 건수
	private int deliveryBeforeCount;				//배송 준비 건수
	private String prePaymentYn;				//선납여부
	private String payableYn;						//결제가능여부
	...
	public int getDeliveryBeforeCount() {
		return deliveryBeforeCount;
	}
	public void setDeliveryBeforeCount(int deliveryBeforeCount) {
		this.deliveryBeforeCount = deliveryBeforeCount;
	}
	public String getSendTargetYn() {
		return sendTargetYn;
	}
	public void setSendTargetYn(String sendTargetYn) {
		this.sendTargetYn = sendTargetYn;
	}
	...
	public void setPayableYn(String payableYn) {
		this.payableYn = payableYn;
	}
