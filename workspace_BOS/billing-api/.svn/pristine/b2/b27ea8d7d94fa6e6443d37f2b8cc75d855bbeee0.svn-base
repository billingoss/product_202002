...
//	private Discount dd[];
	...
	private String deliveryCostYn;
	
	public String getDeliveryCostYn() {
		return deliveryCostYn;
	}
	public void setDeliveryCostYn(String deliveryCostYn) {
		this.deliveryCostYn = deliveryCostYn;
	}
